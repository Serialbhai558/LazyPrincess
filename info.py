...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://DBMANGO:DBMANGO@cluster0.fvanimj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', "")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('-1002121077065', '')).split()]
...
# LAZY_AI_LOGS = int(environ.get("-1002008371985","")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
